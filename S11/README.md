...
This assignment is to learn about getting full modular code. There should be minimal code in notebook, everything is imported from modules. We tried GradCAM to see where model is focusing.
...
- Training/Test Accuracy: 90.27%, 91.24%
